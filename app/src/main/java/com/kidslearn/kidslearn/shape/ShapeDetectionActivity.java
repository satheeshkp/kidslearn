package com.kidslearn.kidslearn.shape;
 ...
 */
public class ShapeDetectionActivity extends AppCompatActivity implements CvCameraViewListener2 {
    /**
     * class name for debugging with logcat
     */
    private static final String TAG = ShapeDetectionActivity.class.getName();
    ...
    public static final String SHAPE_TRANGLE="trangle";
